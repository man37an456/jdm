...
<script src='https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.min.js'></script><script  src="./script.js"></script>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bodas/carrusel5.jpg');">
    ...
    <section class="ftco-section ftco-counter">
        ...
        <div class="container oferta-section triangulos-container  ">
            <div class="row justify-content-center mb-5 pb-9">
                <div class="col-md-12 text-center heading-section heading-section-black ftco-animate">
                    ...
                    <h2 class="mb-4">Jardin Japones</h2>
                    <p>Déjate llevar por el agua y el viento para vivir una experiencia íntima enmarcada por el diseño 
                       único estilo japonés; con elementos en perfecta sintonía y con gran significado cultural que 
                       hará tu evento como lo habías soñado.
                ...
                <div class="col-lg-7 col-md-6 heading-section heading-section-black ftco-animate pl-lg-2  pt-md-0 pt-0">
                    ...
                    <ul>
                        ...
                        <p>
                            ...
                            </div>Capacidad Máxima 100 personas
            ...
            <div class="row justify-content-center mb-5">
                ...
                <div class="video-container">
                    <center>
                       <iframe width="860" height="515" src="https://www.youtube.com/embed/-Wm-tUVbH8g" title="Bodas Japones" 
...
<div class='gallery'>
  <img src='images/1bds.jpg' />
  <img src='images/2japones.jpg' />
  <img src='images/3bds.jpg' />
  <img src='images/4japones.jpg' />
