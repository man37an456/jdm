...
<script src='https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.min.js'></script><script  src="./script.js"></script>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/Bodas/carrusel3.jpg');">
        ...
        <div class="container oferta-section">
            <div class="row justify-content-center mb-5 pb-9">
                <div class="col-md-12 text-center heading-section heading-section-black ftco-animate">
                    <h2 class="mb-4">Salon Bamboo</h2>
                    <p>Rodeado de naturaleza, Salón Bamboo; la palapa más grande de Latinoamérica,
                       cuenta con una magnifica vista al jardín acuático central.
                       Un espacio exclusivo con su propio jardín, espacio ecuménico para las ceremonias y bungalows de novios; el lugar ideal para concretar tu amor y celebrar en grande con tus seres queridos.
                    </p><BR>
                </div>
            </div>
...
<div class='gallery'>
  <img src='images/bambu.jpg' />
  <img src='images/arreglo.jpg' />
  <img src='images/bammboo4.jpg' />
  <img src='images/Bodas/carrusel3.jpg' />
