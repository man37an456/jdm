...
<?php 
$ini -> head('Laberinto De Los Sentidos');
?>
...
<script src='https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.min.js'></script><script  src="./script.js"></script>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bodas/carrusel4.jpg');">
        ...
        <div class="container oferta-section">
            <div class="row justify-content-center mb-5 pb-9">
                <div class="col-md-12 text-center heading-section heading-section-black ftco-animate">
                    ...
                    <p>El único laberinto diseñado no para perderse sino para encontrARTE,
                       ...
                       antesala de nuestra Galería de Arte. 
                    </p><BR>
                </div>
            </div>
            ...
            <div class="row justify-content-center mb-5">
                ...
                <div class="video-container">
                    <center>
    <iframe width="860" height="515" src="https://www.youtube.com/embed/kZMGXK9AiPg" title="Salon bamboo" 
...
<div class='gallery'>
  <img src='images/Jardines/laberinto.jpg' />
  <img src='images/laberinto2.jpg' />
  <img src='images/laberinto3.jpg' />
  <img src='images/laberinto4.jpg' />
