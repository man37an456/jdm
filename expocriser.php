...
<script src='https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.min.js'></script><script  src="./script.js"></script>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/expocriser.jpg');">
        ...
        <div class="container oferta-section">
            <div class="row justify-content-center mb-5 pb-9">
                <div class="col-md-12 text-center heading-section heading-section-black ftco-animate">
                    <h2 class="mb-4">Expocriser</h2>
                    <p>Un espacio al aire libre que gracias asu amplitud, podemos diseñar todo tipo de eventos de ensueño. 
                       Rodeado por el espectacular Jardín Cuatro Primaveras, increíble lugar para celebrar eventos en distintos
...
<div class='gallery'>
  <img src='images/expocriser.jpg' />
  <img src='images/expocriser2.jpg' />
  <img src='images/expocriser3.jpg' />
  <img src='images/expocriser4.jpg' />
